...
(function () {
  ...
  // Валидация формы на странице "телефон упал у воду"
  var ourName = document.getElementById("our-name");
  var ourPhone = document.getElementById("our-phone");

  ourName.addEventListener("invalid", function () {
    formValidation(ourName);
  });

  ourPhone.addEventListener("invalid", function () {
    formValidation(ourPhone);
  });
